...
OBJECT_FILES += obj/ast_binop.o obj/ast_declarator.o obj/ast_function.o obj/ast_jump.o obj/ast_list.o obj/ast_node.o obj/ast_primitives.o obj/ast_translation.o obj/ast_variable.o obj/ast_ifstatement.o obj/ast_loops.o obj/ast_unaryop.o obj/ast_conditional.o
